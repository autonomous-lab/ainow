#!/usr/bin/env python3
"""
Visualize ainow span traces as a Gantt chart.

Usage:
    python scripts/visualize.py /tmp/ainow/<call_id>.json
    python scripts/visualize.py /tmp/ainow/<call_id>.json --save output.png
    python scripts/visualize.py  # uses most recent trace in /tmp/ainow/
"""
...
def main() -> None:
    ...
    if args and args[0].startswith(("http://", "https://")):
        ...
        if trace_path:
            ...
            print("No trace files found in /tmp/ainow/")
            print("Usage: python scripts/visualize.py /tmp/ainow/<call_id>.json")
