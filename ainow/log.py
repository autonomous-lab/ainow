...
def setup_logging(level: int = logging.INFO) -> None:
    ...
    # Force UTF-8 output on Windows (cp1252 can't encode box-drawing / Unicode symbols)
...
class Logger:
    ...
    _logger = logging.getLogger("ainow")
    ...
    def __init__(self, verbose: bool = False):
        self._events_logger = logging.getLogger("ainow.events")
...
class ServiceLogger:
    ...
    def __init__(self, service_name: str):
        self._logger = logging.getLogger("ainow." + service_name)
